#
#  Be sure to run `pod spec lint HHZLoading.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-Loading"

  s.homepage     = "https://github.com/chenzhe555/HHZLoading"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZLoading.git", :tag => "#{s.version}" }
